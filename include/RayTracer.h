...
namespace ray
{
	...
	struct fragment_t
	{
		...
		glm::vec4 _position;
		/// <summary>
		/// Texture coordinate on the surface for the position.
		/// </summary>
		glm::vec2 _texcoord;
		/// <summary>
		/// Surface space matrix for the position.
		/// </summary>
		glm::mat3 _space;
		/// <summary>
		/// Surface normal for the position.
		/// </summary>
		glm::vec3 _normal;
		/// <summary>
		/// Surface tangent for the position.
		/// </summary>
		glm::vec3 _tangent;
		/// <summary>
		/// Surface binormal for the position.
		/// </summary>
		glm::vec3 _binormal;
		/// <summary>
		/// View directional vector for the position.
		/// </summary>
		glm::vec3 _view;
		/// <summary>
		/// Transparency value of the position.
		/// </summary>
		float _transparency;
		/// <summary>
		/// Reflectivity value of the position.
		/// </summary>
		float _reflectivity;
		/// <summary>
		/// Base color of the position.
		/// </summary>
		glm::vec4 _color;
		/// <summary>
		/// Specular color of the position.
		/// </summary>
		glm::vec4 _specular;
		/// <summary>
		/// Emissive color of the position.
		/// </summary>
		glm::vec4 _emissive;
